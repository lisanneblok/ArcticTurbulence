...
def gamma_G_north_atlantic(SP, pt):
    ...
    Fit = np.array(
        [
            ...
            [1.0, 0.0, 4.40022403081395],
            [0.0, 1.0, 0.0324341891674178],
            [2.0, 0.0, -6.45929201288070],
            [1.0, 1.0, -9.92256348514822],
            [0.0, 2.0, 1.72145961018658],
            [3.0, 0.0, -19.3531532033683],
            [2.0, 1.0, 66.9856908160296],
            [1.0, 2.0, -12.9562244122766],
            [0.0, 3.0, -3.47469967954487],
            [4.0, 0.0, 66.0796772714637],
            [3.0, 1.0, -125.546334295077],
            [2.0, 2.0, 7.73752363817384],
            [1.0, 3.0, 10.1143932959310],
            [0.0, 4.0, 5.56029166412630],
            [5.0, 0.0, -54.5838313094697],
            [4.0, 1.0, 70.6874394242861],
            [3.0, 2.0, 36.2272244269615],
            [2.0, 3.0, -26.0173602458275],
            [1.0, 4.0, -0.868664167905995],
            [0.0, 5.0, -3.84846537069737],
            [6.0, 0.0, 10.8620520589394],
            [5.0, 1.0, 0.189417034623553],
            [4.0, 2.0, -36.2275575056843],
            [3.0, 3.0, 22.6867313196590],
...
def gamma_G_south_atlantic(SP, pt):
    ...
    Fit = np.array(
        [
            ...
            [1.0, 0.0, 0.755382324920216],
            [0.0, 1.0, 0.270391840513646],
            [2.0, 0.0, 10.0570534575124],
            [1.0, 1.0, -3.30869686476731],
            [0.0, 2.0, -0.702511207122356],
            [3.0, 0.0, -29.0124086439839],
            [2.0, 1.0, -3.60728647124795],
            [1.0, 2.0, 10.6725319826530],
            [0.0, 3.0, -0.342569734311159],
            [4.0, 0.0, 22.1708651635369],
            [3.0, 1.0, 61.1208402591733],
            [2.0, 2.0, -61.0511562956348],
            [1.0, 3.0, 14.6648969886981],
            [0.0, 4.0, -3.14312850717262],
            [5.0, 0.0, 13.0718524535924],
            [4.0, 1.0, -106.892619745231],
            [3.0, 2.0, 74.4131690710915],
            [2.0, 3.0, 5.18263256656924],
            [1.0, 4.0, -12.1368518101468],
            [0.0, 5.0, 2.73778893334855],
            [6.0, 0.0, -15.8634717978759],
            [5.0, 1.0, 51.7078062701412],
            [4.0, 2.0, -15.8597461367756],
            [3.0, 3.0, -35.0297276945571],
...
def gamma_G_pacific(SP, pt):
    ...
    Fit = np.array(
        [
            ...
            [1.0, 0.0, 1.10691302482411],
            [0.0, 1.0, 0.0545075600726227],
            [2.0, 0.0, 5.48298954708578],
            [1.0, 1.0, -1.81027781763969],
            [0.0, 2.0, 0.673362062889351],
            [3.0, 0.0, -9.59966716439147],
            [2.0, 1.0, -11.1211267642241],
            [1.0, 2.0, 6.94431859780735],
            [0.0, 3.0, -3.35534931941803],
            [4.0, 0.0, -15.7911318241728],
            [3.0, 1.0, 86.4094941684553],
            [2.0, 2.0, -63.9113580983532],
            [1.0, 3.0, 23.1248810527697],
            [0.0, 4.0, -1.19356232779481],
            [5.0, 0.0, 48.3336456682489],
            [4.0, 1.0, -145.889251358860],
            [3.0, 2.0, 95.6825154064427],
            [2.0, 3.0, -8.43447476300482],
            [1.0, 4.0, -16.0450914593959],
            [0.0, 5.0, 3.51016478240624],
            [6.0, 0.0, -28.5141488621899],
            [5.0, 1.0, 72.6259160928028],
            [4.0, 2.0, -34.7983038993856],
            [3.0, 3.0, -21.9219942747555],
...
def gamma_G_indian(SP, pt):
    ...
    Fit = np.array(
        [
            ...
            [1.0, 0.0, 2.52567287174508],
            [0.0, 1.0, 0.276709571734987],
            [2.0, 0.0, -0.531583207697361],
            [1.0, 1.0, -5.95006196623071],
            [0.0, 2.0, -1.29591003712053],
            [3.0, 0.0, -6.52652369460365],
            [2.0, 1.0, 23.8940719644002],
            [1.0, 2.0, -0.628267986663373],
            [0.0, 3.0, 3.75322031850245],
            [4.0, 0.0, 1.92080379786486],
            [3.0, 1.0, 0.341647815015304],
            [2.0, 2.0, -39.2270069641610],
            [1.0, 3.0, 14.5023693075710],
            [0.0, 4.0, -5.64931439477443],
            [5.0, 0.0, 20.3803121236886],
            [4.0, 1.0, -64.7046763005989],
            [3.0, 2.0, 88.0985881844501],
            [2.0, 3.0, -30.0525851211887],
            [1.0, 4.0, 4.04000477318118],
            [0.0, 5.0, 0.738499368804742],
            [6.0, 0.0, -16.6137493655149],
            [5.0, 1.0, 46.5646683140094],
            [4.0, 2.0, -43.1528176185231],
            [3.0, 3.0, 0.754772283610568],
...
def gamma_G_southern_ocean(SP, pt, p):
    ...
    Fit_N = np.array(
        [
            ...
            [1.0, 0.0, -1.64820627969497],
            [0.0, 1.0, 2.05462556912973],
            [2.0, 0.0, 28.0996269467290],
            [1.0, 1.0, -8.27848721520081],
            [0.0, 2.0, -9.03290825881587],
            [3.0, 0.0, -91.0872821653811],
            [2.0, 1.0, 34.8904015133508],
            [1.0, 2.0, 0.949958161544143],
            [0.0, 3.0, 21.4780019724540],
            [4.0, 0.0, 133.921771803702],
            [3.0, 1.0, -50.0511970208864],
            [2.0, 2.0, -4.44794543753654],
            [1.0, 3.0, -11.7794732139941],
            [0.0, 4.0, -21.0132492641922],
            [5.0, 0.0, -85.1619212879463],
            [4.0, 1.0, 7.85544471116596],
            [3.0, 2.0, 44.5061015983665],
            [2.0, 3.0, -32.9544488911897],
            [1.0, 4.0, 31.2611766088444],
            [0.0, 5.0, 4.26251346968625],
            [6.0, 0.0, 17.2136374200161],
            [5.0, 1.0, 13.4683704071999],
            [4.0, 2.0, -27.7122792678779],
            [3.0, 3.0, 11.9380310360096],
    ...
    Fit_S = np.array(
        [
            [0.0, 0.0, 0.209190309846492],
            [1.0, 0.0, -1.92636557096894],
            [0.0, 1.0, -3.06518655463115],
            [2.0, 0.0, 9.06344944916046],
            [1.0, 1.0, 2.96183396117389],
            [0.0, 2.0, 39.0265896421229],
            [3.0, 0.0, -15.3989635056620],
            [2.0, 1.0, 3.87221350781949],
            [1.0, 2.0, -53.6710556192301],
            [0.0, 3.0, -215.306225218700],
            [4.0, 0.0, 8.31163564170743],
            [3.0, 1.0, -3.14460332260582],
